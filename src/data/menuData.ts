...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    title: "Desserts",
    items: [
      { no: 1, name: "Dark Chocolate Sin", pricePc: "1,950", priceKg: "2,600" },
      { no: 2, name: "Irish Coffee Biscotti", pricePc: "1,785", priceKg: "2,380" },
      { no: 3, name: "Exotic Fruit Trifle Pudding", recommended: true, pricePc: "1,695", priceKg: "2,260" },
      { no: 4, name: "Cheese Cake (Strawberry / Blueberry / Lemon / Choc)", priceHalfKg: "1,230", priceKg: "2,460" },
      { no: 5, name: "Tiramisu", recommended: true, pricePc: "1,800", priceKg: "2,400" },
      { no: 6, name: "Crème Brûlée (min 8)", pricePc: "180/pc" },
      { no: 7, name: "Banoffee Pie", priceHalfKg: "1,100", priceKg: "2,200" },
      { no: 8, name: "Tres Leches Gold", pricePc: "1,785", priceKg: "2,380" },
      { no: 9, name: "Molten Choc with Sauce", priceHalfKg: "1,110", priceKg: "2,220" },
      { no: 10, name: "Choc Orange Trifle (or Strawberry)", pricePc: "1,785", priceKg: "2,380" },
      { no: 11, name: "Choc Nougat Biscotti", recommended: true, pricePc: "1,845", priceKg: "2,460" },
      ...
      { no: 17, name: "Choc Mud Pie", pricePc: "1,875", priceKg: "2,500" },
