...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    title: "Desserts",
    items: [
      { no: 1, name: "Dark Chocolate Sin", priceHalfKg: "1,950", priceKg: "2,600" },
      { no: 2, name: "Irish Coffee Biscotti", priceHalfKg: "1,785", priceKg: "2,380" },
      { no: 3, name: "Exotic Fruit Trifle Pudding", recommended: true, priceHalfKg: "1,695", priceKg: "2,260" },
      { no: 4, name: "Cheese Cake (Strawberry / Blueberry / Lemon / Choc)", priceHalfKg: "1,230", priceKg: "2,460" },
      { no: 5, name: "Tiramisu", recommended: true, priceHalfKg: "1,800", priceKg: "2,400" },
      { no: 6, name: "Crème Brûlée (min 8)", pricePc: "180/pc" },
      { no: 7, name: "Banoffee Pie", priceHalfKg: "1,100", priceKg: "2,200" },
      { no: 8, name: "Tres Leches Gold", priceHalfKg: "1,785", priceKg: "2,380" },
      { no: 9, name: "Molten Choc with Sauce", priceHalfKg: "1,110", priceKg: "2,220" },
      { no: 10, name: "Choc Orange Trifle (or Strawberry)", priceHalfKg: "1,785", priceKg: "2,380" },
      { no: 11, name: "Choc Nougat Biscotti", recommended: true, priceHalfKg: "1,845", priceKg: "2,460" },
      { no: 12, name: "Éclairs / Profiteroles (min 9pc)", pricePc: "2,320" },
      { no: 13, name: "New York Cheese Cake", priceHalfKg: "1,260", priceKg: "2,520" },
      { no: 14, name: "Citrus Yogi Bliss", priceKg: "1,550" },
      { no: 15, name: "Choc Hazelnut Swiss Rolls", priceHalfKg: "1,190", priceKg: "2,380" },
      { no: 16, name: "Choc Tuxedo Cheese Cake", recommended: true, priceKg: "3,500" },
      { no: 17, name: "Choc Mud Pie", priceHalfKg: "1,875", priceKg: "2,500" },
      { no: 18, name: "Lotus Biscoff Cheese Cake", priceHalfKg: "1,350", priceKg: "2,700" },
    ],
  },
  {
    title: "Pies & Tarts",
